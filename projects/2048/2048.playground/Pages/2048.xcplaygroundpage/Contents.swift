...
struct Style {
    ...
    let tileBackgroundColors = [
        #colorLiteral(red: 0.7622138857841492, green: 0.707911491394043, blue: 0.643825888633728, alpha: 1.0), #colorLiteral(red: 1.0, green: 0.933319091796875, blue: 0.854888916015625, alpha: 1.0), #colorLiteral(red: 0.9098039216, green: 0.8549019608, blue: 0.7490196078, alpha: 1), #colorLiteral(red: 0.9333333333, green: 0.6392156863, blue: 0.3960784314, alpha: 1),
        ...
        #colorLiteral(red: 0.9955411553382874, green: 0.7768716812133789, blue: -0.23965492844581604, alpha: 1.0), #colorLiteral(red: 0.8745098039, green: 0.7137254902, blue: 0.1333333333, alpha: 1), #colorLiteral(red: 0.9137254902, green: 0.7333333333, blue: 0.1921568627, alpha: 1), #colorLiteral(red: 0.9430862069129944, green: 0.7287830710411072, blue: -0.2528753876686096, alpha: 1.0)
    ]
